...
const CANNONS := {
	...
	"missile_cannon": {"hp": 70, "damage": 26, "range": 200.0, "cooldown": 3.40, "speed": 0.0, "cost": 0,
		"dir": "res://assets/z/cannons_missile", "sound": "MOBIMISS"},
}
