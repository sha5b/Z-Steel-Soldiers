...
MAP = [
    ...
    ("hud amount bar", "other/hud", "fort HP bar (world)", "WIRED",
     "unit_amount_bar_<team>.png, cropped to remaining health (selection-ring bars are procedural)"),
    ...
    ("GOG PMHSprites", "gog/PNG/PMHSprites.png", "-", "COPIED (GOG), NOT WIRED",
     "in-game HUD atlas: panel outline, round buttons, arrows, unit medallions"),
